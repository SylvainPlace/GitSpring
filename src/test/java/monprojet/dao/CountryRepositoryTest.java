...
public class CountryRepositoryTest {
    ...
    @Test
    void testPopulationDuPays() {
        log.info("On vérifie que la France à 12 de population");
            assertEquals(countryDAO.populationDuPays(1), 12, "On doit avoir 12 dans la France" );
    }

    @Test
    void testListePopPays() {
        log.info("On vérifie que nous avons bien une map avec les pays et leur population");
        
        Map<String, Integer> m = new HashMap<String, Integer>();
        m.put("France", 12);
        m.put("United Kingdom", 18);
        m.put("United States of America", 27);
            assertEquals(countryDAO.listePopPays(), m, "On doit avoir notre map qui correspond à la liste des pays" );
    }
